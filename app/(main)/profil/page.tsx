...
import tumbnail_video from '@/public/img/hero_section7.jpeg'
import { Button } from '@/components/ui/button';
import Image from 'next/image';
import kepala_RS from "@/public/img/ketua_RS.png"
import { Card, CardContent } from '@/components/ui/card';
import HistoryTimeline from '@/components/HIstory';
import { GraduationCap, HeartPulse, Quote, ShieldCheck } from 'lucide-react';
...
export default function Page() {
    return (
        <div className="px-4 md:px-10">
            ...
            <Banner title="Profil Rumah Sakit" />

            {/* Sambutan Kepala RS Section */}
                    ...
                    <div className="flex justify-center items-start w-full order-2 lg:col-start-3 lg:row-start-1 lg:row-span-2 mt-10 lg:mt-0">
                        <div className="px-12 py-8 relative rounded-2xl shadow-xl/30 bg-white/80 overflow-hidden flex flex-col items-center">
                            <Image
                                src={kepala_RS}
                                alt="hero2img"
                                className="w-full max-w-[300px] drop-shadow-[0_20px_20px_rgba(0,0,0,0.5)]"
                            />
                            <div className="absolute bottom-0 left-0 w-full flex justify-center">
                                ...
                                <div className="relative flex items-center gap-2 w-full justify-center backdrop-blur-md bg-white/40 py-3 px-5">
                                    <span className="font-semibold text-base md:text-lg text-black text-center">Kapten Ckm dr.Budi Yuliono,Sp.B,MMRS.,FINACS</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="bg-black/90 rounded-3xl mb-20 px-4 md:px-12 lg:px-20 py-12 md:py-20 gap-5">
                <HistoryTimeline />
            </div>

            <h1 className='text-3xl md:text-4xl ml-2 mt-20'>Video Company Profil</h1>
            ...
            <h1 className='text-3xl md:text-4xl ml-2 mt-20'>Tujuan Dan Filosofi</h1>
            <h3 className='mb-5 ml-2'>Rumah Sakit Tingkat 04.07.01 Tegal</h3>
            ...
            <div className='flex flex-col lg:flex-row gap-10'>
                <div className='flex-1'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-3 gap-5'>
                        <div className='relative group bg-black rounded-3xl p-6 md:p-8 h-full flex flex-col justify-start overflow-hidden transition-all duration-300 hover:scale-[1.03] hover:-translate-y-1'>
                            {/* Efek Glow */}
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[200%] h-[150%] bg-[radial-gradient(circle_at_top,_rgba(249,115,22,0.15)_0%,_transparent_40%)] opacity-70 group-hover:opacity-100 transition-opacity duration-300"></div>
                            <div className="relative z-10">
                                <div className="bg-orange-400 border border-slate-700 w-14 h-14 rounded-2xl flex items-center justify-center mb-5">
                                    <HeartPulse className="w-7 h-7 text-white" />
                                </div>
                                <h3 className="text-white/80 text-lg font-light leading-tight">
            ...
            <div>
                <h1 className='text-3xl md:text-4xl mt-20 ml-2 '>Misi, Visi, Moto</h1>
                <h3 className='mb-5 ml-2'>Rumah Sakit Tingkat 04.07.01 Tegal</h3>
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 mb-20'>

                    <div className='bg-black border border-black rounded-3xl p-6 md:p-10 relative h-[400px] md:h-[500px]'>
                        <h1 className='absolute top-10 z-0 text-orange-500 text-7xl md:text-8xl font-bold'>MISI</h1>
                        <div className='relative mt-16 md:mt-25'>
                    ...
                    <div className='bg-black rounded-3xl p-6 md:p-10 relative h-[400px] md:h-[500px]'>
                        ...
                        <h1 className='absolute top-10 z-0 text-orange-500 text-7xl md:text-8xl font-bold'>VISI</h1>
                        <div className='relative mt-16 md:mt-25'>
                    ...
                    <div className='flex-1 h-[400px] md:h-[500px] relative overflow-hidden'>
                        <Image src={logo1} alt='bg_moto' className='rounded-3xl' />
                        <div className='absolute inset-x-0 bottom-0 bg-gradient-to-t from-black via-black/70 to-transparent p-6 md:p-10 rounded-b-3xl'>
