...
import foto_aula from '@/public/img/foto_aula.png'
...
const HistoryTimeline: React.FC = () => {
    return (
        <div className="flex flex-col lg:flex-row mx-auto p-4 md:p-12 gap-10">
            {/* --- Bagian Judul --- */}
            <div className="flex-1">
                <h1 className="text-2xl md:text-4xl font-extralight text-background mb-3">
                ...
                <Image src={foto_aula} alt='foto_sejarah' className='top-25 sticky rounded-xl'/>
            </div>
